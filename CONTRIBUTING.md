...
Match the surrounding code, comment *why* not *what*, name things from the domain, and keep
error/log strings factual. `.editorconfig` + StyleCop enforce the mechanical parts;
