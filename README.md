...
See [CONTRIBUTING.md](CONTRIBUTING.md) and the house style in [STYLE.md](STYLE.md). `dotnet format`
is the gate; keep new code in the style of the files around it.
